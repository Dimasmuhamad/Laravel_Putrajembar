                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="checkout__form__input">
                                    ...
                                    <input type="text" name="phone_number" value="{{ auth()->user()->nomor_telp }}"  required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="checkout__form__input">
                                    ...
                                    <select name="courier" id="courier">
                                        ...
                                        <option value="prshn">Dikirim Perusahaan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="checkout__order">
                            ...
                            <div class="checkout__order__product">
                                <ul>
                                    ...
                                    @endforeach
                                    <li>
                                        <span class="top__text">Berat keseluruhan</span>
...
function checkCost() {
    ...
    if (courier === 'prshn') {
        ...
        $('#shipping_method').append('<option value="prshn" selected>Dikirim Perusahaan</option>');
        countCost(10000);
    } else {
        let _url = `/rajaongkir/cost`;
        let _token = $('meta[name="csrf-token"]').attr('content');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response) {
                    $('#shipping_method').empty();
                    $('#shipping_method').append('<option value="" selected disabled>-- Select Shipment Service --</option>');
        ...
        success: function(data) {
            ...
            if (data) {
                ...
                $.each(data, function(key, city) {
                    $('#city_id').append('<option value="' + city.city_name + '" data-id="'+city.city_id+'">' + city.type + ' ' + city.city_name +
                        '</option>');
                });
                checkCost();
            } else {
