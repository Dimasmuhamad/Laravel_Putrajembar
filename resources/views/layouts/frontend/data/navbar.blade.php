 ...
 <div class="offcanvas-menu-wrapper">
     ...
     <div class="offcanvas__logo">
         <a href="{{ url('/') }}">Putra Jembar</a>
     </div>
     {{-- <div class="offcanvas__logo">
         <a href="{{ url('/') }}">
             <img src="{{ asset('me/img/logo.jpeg') }}" alt="Putra Jembar" />
         </a>
     </div> --}}
         ...
         <div class="row">
             <div class="col-xl-3 col-lg-2">
                 <div class="">
                     ...
                     <img src="{{ asset('me/img/logo.jpeg') }}" alt="Putra Jembar" class="title-logo" />
                 </div>
             </div>
                 ...
                 <nav class="header__menu">
                     <ul>
                         ...
                         <li class="{{ request()->is('product*') ? 'active' : '' }}"><a
                                 href="{{ route('product.index') }}">Belanja</a></li>
